...
class Portfolio extends Component {
  ...
  return (
      ...
      <div className="col-md-6">
        <div className="container-fluid">
          ...
          <div className="row">
            ...
            <p>I built the frontend with React.js for the first time. For that I studied <strong>Webpack</strong>, <strong>ES6</strong> and <strong>Babel</strong>. The backend (API) I built with Node.js & Express.js and the communication between front- and backend with <strong>Fetch</strong>. I also dabbled with some AWS stuff:</p>
    ...
    <div className="row">
      <div className="col-md-6">
        <Image src={require('../assets/images/mysli.jpg')} responsive/>
      </div>
      <div className="col-md-6">
        <div className="container-fluid">
          <div className="row">
    ...
    <div className="row">
      <div className="col-md-6">
        <Image src={require('../assets/images/tilemap.png')} responsive/>				
      </div>
      <div className="col-md-6">
        <div className="container-fluid">
          <div className="row">
    ...
    <div className="row">
      <div className="col-md-6">
        <Image src={require('../assets/images/portfolio.png')} responsive/>				
      </div>
      <div className="col-md-6">
        <div className="container-fluid">
          <div className="row">
